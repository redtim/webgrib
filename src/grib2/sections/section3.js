 ...
 */
export function parseSection3(r, bodyLen) {
    const start = r.pos;
...
function readEarthShape(r) {
    ...
    switch (shapeOfEarth) {
        case 0:
            earthRadius = 6_367_470;
            break;
        case 1:
            earthRadius = scaledValueRadius * Math.pow(10, -scaleFactorRadius);
            break;
        case 2:
            earthRadius = 6_378_160;
            break; // IAU 1965 oblate
        case 3:
            earthRadius = 6_371_229;
            break; // user-specified oblate — approximate
        case 4:
            earthRadius = 6_378_137;
            break; // IAG-GRS80
        case 5:
            earthRadius = 6_378_137;
            break; // WGS84
 ...
 *    scanning mode (1)
 */
function parseTemplate3_0(r, numberOfPoints) {
 ...
 */
function parseTemplate3_30(r, numberOfPoints) {
    const earth = readEarthShape(r);
    const nx = r.uint32();
    const ny = r.uint32();
